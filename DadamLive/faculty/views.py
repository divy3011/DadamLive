...
def view_course(request,course_id):
    ...
    if request.method=="POST":
        ...
        TA_permissions=TeachingAssistantPermission.objects.filter(enrolment__course=course, enrolment__userType__userTypeCode=settings.CODE_TA)
        ta_contacts=[]
...
def match_student_answers(request, quiz_id):
    ...
    if True:
        for w in written:
            ...
            if all_answers[0]=='' or all_answers[1]=='':
                continue                                                                                                                                                                                                
