...
Promise.all([
  ...
  faceapi.nets.faceLandmark68Net.loadFromUri("http://127.0.0.1:8000/static/models"),
  faceapi.nets.faceRecognitionNet.loadFromUri("http://127.0.0.1:8000/static/models"),
  faceapi.nets.faceExpressionNet.loadFromUri("http://127.0.0.1:8000/static/models"),
  faceapi.nets.ageGenderNet.loadFromUri("http://127.0.0.1:8000/static/models")
]).then(startVideo);
